...
import { useCreateProductionOrder } from "../hooks/useProductionOrdersHooks";
import { productionOrderSchema, type ProductionOrderFormValues } from "../types/production-order.types";
...
export function AddProductionOrderDialog() {
          ...
          >
            <div className="flex items-center justify-between p-6 border-b border-white/10 bg-zinc-900/50 flex-shrink-0">
              <div>
                ...
                <p className="text-sm text-white/50 mt-1">Fill in the details to create a new production order.</p>
              </div>
              <button
                onClick={() => store.setCreateModalOpen(false)}
