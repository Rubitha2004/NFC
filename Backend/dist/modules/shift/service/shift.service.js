...
const shift_repository_1 = require("../repository/shift.repository");
class ShiftService {
    repository = new shift_repository_1.ShiftRepository();
    ...
    calculateWorkingHours(startTime, endTime, breakStart, breakEnd) {
