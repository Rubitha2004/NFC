...
const machine_type_routes_1 = __importDefault(require("../modules/machine-type/routes/machine-type.routes"));
...
router.use("/machine-types", machine_type_routes_1.default);
